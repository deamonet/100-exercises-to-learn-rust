...
pub struct WeekTemperatures {
    temperature_array: [Option<i32>; 7],
}
...
impl WeekTemperatures {
    pub fn new() -> Self {
        WeekTemperatures {
            temperature_array: [None; 7],
        }
    }

    pub fn get_temperature(&self, day: Weekday) -> Option<i32> {
        self.temperature_array[Self::match_day_no(day)]
    }

    pub fn set_temperature(&mut self, day: Weekday, temperature: i32) {
        self.temperature_array[Self::match_day_no(day)] = Some(temperature)
    }

    fn match_day_no(day: Weekday) -> usize {
        match day {
            Weekday::Monday => 0,
            Weekday::Tuesday => 1,
            Weekday::Wednesday => 2,
