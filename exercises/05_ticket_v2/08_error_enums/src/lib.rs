...
fn easy_ticket(title: String, description: String, status: Status) -> Ticket {
    ...
    match result {
        Ok(ticket) => ticket,
        Err(ticketNewError) => match ticketNewError {
            TicketNewError::TitleError { message: _ } => panic!("{}", ticketNewError.message()),
            TicketNewError::DescriptionError { message: _ } => Ticket::new(
                title_clone,
